...
The first Rust workspace release. This supersedes the previous pure-Python
`pyflexaudio` package (its documentation now lives in `README.python.md`).
...
[Unreleased]: https://github.com/tsubome/pyflexaudio/compare/v0.2.0...HEAD
[0.2.0]: https://github.com/tsubome/pyflexaudio/releases/tag/v0.2.0
